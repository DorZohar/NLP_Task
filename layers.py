...
def guess_missing_word_model():
	...
	sentence2_formatter = Model(inputs=[sentence2_embedding,sentence2_index_to_remove], outputs=[first_part,second_part])
	...
	second_part_model_output= LSTM(LSTM_hidden_size, input_shape=(cfg.embedding_size, 1), go_backwards=True)(second_part_model_input)	
